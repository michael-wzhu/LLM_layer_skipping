...
class GPT2Block(nn.Module):
    ...
    def forward(
        ...
        hidden_states = attn_output * F.sigmoid(layer_attn_gate) * 2 * layer_attn_mask \
        ...
        hidden_states = feed_forward_hidden_states * F.sigmoid(layer_ffn_gate) * 2 * layer_ffn_mask \
...
class GPT2Model(GPT2PreTrainedModel):
    ...
    def forward(
        ...
        return_dict: Optional[bool] = None,
            ...
            layer_attn_masks=None,
            layer_ffn_masks=None,
        ...
        for i, (block, layer_past) in enumerate(zip(self.h, past_key_values)):
            ...
            if self.gradient_checkpointing and self.training:
                ...
                def create_custom_forward(module):
                    def custom_forward(*inputs):
                        ...
                        return module(*inputs, use_cache, output_attentions,
                                      ...
                                      layer_attn_masks[i], layer_ffn_masks[i],
                                      )
                ...
                outputs = block(
                    ...
                    layer_attn_mask=layer_attn_masks[i],
                    layer_ffn_mask=layer_ffn_masks[i]
                )
...
class GPT2LMHeadModel(GPT2PreTrainedModel):
    ...
    def forward(
        ...
        transformer_outputs = self.transformer(
            ...
            layer_attn_gates=self.layer_attn_gates,
            layer_ffn_gates=self.layer_ffn_gates,
            layer_attn_masks=layer_attn_masks,
            layer_ffn_masks=layer_ffn_masks,
        )
    ...
    def consistency_loss(self,
        ...
        batch["layer_attn_masks"] = layer_attn_masks_1
        batch["layer_ffn_masks"] = layer_ffn_masks_1
        output_1 = self(**batch)

        batch["layer_attn_masks"] = layer_attn_masks_2
        batch["layer_ffn_masks"] = layer_ffn_masks_2
        output_2 = self(**batch)
